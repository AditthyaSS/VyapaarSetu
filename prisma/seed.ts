...
async function main() {
    ...
    // Create models
    const modelData = [
        { slug: "o3", name: "o3", providerId: providerMap["OpenAI"], contextWindow: 200000, inputPricePerMtok: 10.0, outputPricePerMtok: 40.0, benchmarkGpqa: 96.7, benchmarkMmlu: 96.1, license: "Proprietary", modalities: ["text"], isOpenSource: false, speedToksPerSec: 42, isVerified: true, tags: ["reasoning", "frontier"] },
        { slug: "gpt-5", name: "GPT-5", providerId: providerMap["OpenAI"], contextWindow: 128000, inputPricePerMtok: 30.0, outputPricePerMtok: 60.0, benchmarkGpqa: 92.1, benchmarkMmlu: 93.4, license: "Proprietary", modalities: ["text", "image"], isOpenSource: false, speedToksPerSec: 55, isVerified: true, tags: ["multimodal", "frontier"] },
        { slug: "claude-opus-4", name: "Claude Opus 4", providerId: providerMap["Anthropic"], contextWindow: 200000, inputPricePerMtok: 15.0, outputPricePerMtok: 75.0, benchmarkGpqa: 89.3, benchmarkMmlu: 91.2, license: "Proprietary", modalities: ["text"], isOpenSource: false, speedToksPerSec: 38, isVerified: true, tags: ["reasoning", "analysis", "frontier"] },
        ...
        { slug: "gpt-4o", name: "GPT-4o", providerId: providerMap["OpenAI"], contextWindow: 128000, inputPricePerMtok: 2.5, outputPricePerMtok: 10.0, benchmarkGpqa: 79.4, benchmarkMmlu: 87.2, license: "Proprietary", modalities: ["text", "image", "audio"], isOpenSource: false, speedToksPerSec: 82, isVerified: true, tags: ["multimodal", "versatile"] },
        ...
        { slug: "gemini-2-5-flash", name: "Gemini 2.5 Flash", providerId: providerMap["Google DeepMind"], contextWindow: 1000000, inputPricePerMtok: 0.075, outputPricePerMtok: 0.3, benchmarkGpqa: 70.5, benchmarkMmlu: 78.2, license: "Proprietary", modalities: ["text", "image"], isOpenSource: false, speedToksPerSec: 150, isVerified: true, tags: ["fast", "efficient", "long-context"] },
